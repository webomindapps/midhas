<x-page-content title="Customer Master">
    <x-slot:breadcrumb>
        {{-- <x-admin.export-btn>
            <li>
    ...
    <x-table :columns="$columns" :data="$customers" checkAll="{{ false }}" :bulk="route('admin.customers.destroy', ['customer' => 'bulk'])" :route="route('admin.customers.index')">
        @foreach ($customers as $key => $item)
            @php
                ...
                $actions = [
                    ...
                    [
                        'code' => 'view',
                        'route' => route('admin.customers.show', $item->id),
                    ],
                ];
            @endphp
            <tr>
