            ...
            <div class="container d-flex align-items-center justify-content-between">
                ...
                <div class="col-md-5 right_side_action">
                    <div class="d-flex text-center justify-content-end align-items-center">
                        ...
                        <div class="cart ms-4 hover-box position-relative" id="miniCart">
                            <a href="{{ route('cart') }}">
                                <i class="fa-solid fa-basket-shopping"></i>
                                <span class="d-block">My Cart
                                    <span id="item-count" class="badge bg-danger ">0</span>
                                </span>
                            </a>
                            <div id="hovedCart" class="mini-cart-content"></div>
                        </div>
                    </div>
                </div>
            </div>
